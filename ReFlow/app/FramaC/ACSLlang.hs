...
instance PPExt FBExpr where
  ...
  prettyDoc (FRel Eq  a1 a2) = parens $ text "Deq" <> parens (prettyDoc a1 <> comma <> prettyDoc a2)
  prettyDoc (FRel Neq a1 a2) = parens $ text "Dne" <> parens (prettyDoc a1 <> comma <> prettyDoc a2)
  prettyDoc (FRel Lt  a1 a2) = parens $ text "Dlt" <> parens (prettyDoc a1 <> comma <> prettyDoc a2)
  prettyDoc (FRel LtE a1 a2) = parens $ text "Dle" <> parens (prettyDoc a1 <> comma <> prettyDoc a2)
  prettyDoc (FRel Gt  a1 a2) = parens $ text "Dgt" <> parens (prettyDoc a1 <> comma <> prettyDoc a2)
  prettyDoc (FRel GtE a1 a2) = parens $ text "Dge" <> parens (prettyDoc a1 <> comma <> prettyDoc a2)
  prettyDoc (FBetween lb a ub) = parens $ text "Dlt" <> parens (prettyDoc lb <> comma <> prettyDoc a)
                                      <+> text "&&"
                                      <+> text "Dlt" <> parens (prettyDoc a <> comma <> prettyDoc ub)
  ...
  prettyDoc (EqualFP ae1 ae2) = text "equal_fp" <> parens (prettyDoc ae1 <> comma <> prettyDoc ae2)
