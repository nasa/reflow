...
? \let centry_double = coalt_entry_fp(sz_double, vz_double, TCOA_double, ZTHR_double) ;
  ((Dsub(T_double, centry_double) < (double) (0)) ? (Dsub(B_double, T_double)) : (max__fp(B_double, centry_double))) :
...
((((((((((! (((\abs(sz) - ZTHR) <= 0)) && ! ((vz != 0))) && ((! ((Dsub(Dabs(sz_double), ZTHR_double) <= (double) (0))) && ! ((vz_double != (double) (0)))) && (\true && \true))) || (((vz != 0) && (! (((T - coalt_entry(sz, vz, TCOA, ZTHR)) < 0)) && ! (((B - coalt_entry(sz, vz, TCOA, ZTHR)) < 0)))) && (((vz_double != (double) (0)) && (! ((Dsub(T_double, coalt_entry_fp(sz_double, vz_double, TCOA_double, ZTHR_double)) < (double) (0))) && ! ((Dsub(B_double, coalt_entry_fp(sz_double, vz_double, TCOA_double, ZTHR_double)) < (double) (0))))) && (\true && \true)))) || (((vz != 0) && (! (((T - coalt_entry(sz, vz, TCOA, ZTHR)) < 0)) && ((B - coalt_entry(sz, vz, TCOA, ZTHR)) < 0))) && (((vz_double != (double) (0)) && (! ((Dsub(T_double, coalt_entry_fp(sz_double, vz_double, TCOA_double, ZTHR_double)) < (double) (0))) && (Dsub(B_double, coalt_entry_fp(sz_double, vz_double, TCOA_double, ZTHR_double)) < (double) (0)))) && (\true && \true)))) || (((vz != 0) && (! (((ZTHR - (\abs(vz) * TCOA)) <= 0)) && ! ((vz >= 0)))) && (((vz_double != (double) (0)) && (! ((Dsub(ZTHR_double, Dmul(Dabs(vz_double), TCOA_double)) <= (double) (0))) && ! ((vz_double >= (double) (0))))) && ((vz != 0) && (vz_double != (double) (0)))))) || (((vz != 0) && (! (((ZTHR - (\abs(vz) * TCOA)) <= 0)) && (vz >= 0))) && (((vz_double != (double) (0)) && (! ((Dsub(ZTHR_double, Dmul(Dabs(vz_double), TCOA_double)) <= (double) (0))) && (vz_double >= (double) (0)))) && ((vz != 0) && (vz_double != (double) (0)))))) || (((vz != 0) && (((ZTHR - (\abs(vz) * TCOA)) <= 0) && ! ((vz >= 0)))) && (((vz_double != (double) (0)) && ((Dsub(ZTHR_double, Dmul(Dabs(vz_double), TCOA_double)) <= (double) (0)) && ! ((vz_double >= (double) (0))))) && ((vz != 0) && (vz_double != (double) (0)))))) || (((vz != 0) && (((ZTHR - (\abs(vz) * TCOA)) <= 0) && (vz >= 0))) && (((vz_double != (double) (0)) && ((Dsub(ZTHR_double, Dmul(Dabs(vz_double), TCOA_double)) <= (double) (0)) && (vz_double >= (double) (0)))) && ((vz != 0) && (vz_double != (double) (0)))))) || (((vz != 0) && ((T - coalt_entry(sz, vz, TCOA, ZTHR)) < 0)) && (((vz_double != (double) (0)) && (Dsub(T_double, coalt_entry_fp(sz_double, vz_double, TCOA_double, ZTHR_double)) < (double) (0))) && (\true && \true)))) || ((((\abs(sz) - ZTHR) <= 0) && ! ((vz != 0))) && (((Dsub(Dabs(sz_double), ZTHR_double) <= (double) (0)) && ! ((vz_double != (double) (0)))) && (\true && \true))));
}
*/
...
behavior structure:
ensures (((((((((((\is_finite(B_double) && \is_finite(T_double)) && \is_finite(sz_double)) && \is_finite(vz_double)) && \is_finite(TCOA_double)) && \is_finite(ZTHR_double)) && \is_finite(E_0_double)) && \is_finite(E_1_double)) && \is_finite(E_2_double)) && \is_finite(E_3_double)) && \is_finite(E_4_double))
...
ensures \forall real B, real T, real sz, real vz, real TCOA, real ZTHR; ((((((\abs(vz_double - vz) <= E_0_double && \let Z_COA_double = Dmul(Dabs(vz_double), TCOA_double);
                                                                                                                    (\let Z_COA = (\abs(vz) * TCOA);
                                                                                                                     (\abs(Dsub(ZTHR_double, Dmul(Dabs(vz_double), TCOA_double)) - (ZTHR - (\abs(vz) * TCOA))) <= E_1_double))) && (! ((Dsub(T_double, centry_double) < (double) (0)))
                                                                                                                                                                                                                                    ==> (\let centry_double = coalt_entry_fp(sz_double, vz_double, TCOA_double, ZTHR_double);
                                                                                                                                                                                                                                         (\let centry = coalt_entry(sz, vz, TCOA, ZTHR);
                                                                                                                                                                                                                                          (\abs(Dsub(B_double, centry_double) - (B - centry)) <= E_2_double))))) && \let centry_double = coalt_entry_fp(sz_double, vz_double, TCOA_double, ZTHR_double);
                                                                                                                                                                                                                                                                                                                    (\let centry = coalt_entry(sz, vz, TCOA, ZTHR);
                                                                                                                                                                                                                                                                                                                     (\abs(Dsub(T_double, centry_double) - (T - centry)) <= E_3_double))) && \abs(Dsub(Dabs(sz_double), ZTHR_double) - (\abs(sz) - ZTHR)) <= E_4_double)
                                                                          ==> (((((((((((((\is_finite(B_double) && \is_finite(T_double)) && \is_finite(sz_double)) && \is_finite(vz_double)) && \is_finite(TCOA_double)) && \is_finite(ZTHR_double)) && \is_finite(E_0_double)) && \is_finite(E_1_double)) && \is_finite(E_2_double)) && \is_finite(E_3_double)) && \is_finite(E_4_double)) && \result.isValid)
...
*/
struct maybeDouble vertical_WCV_exit_minus_entry_fp (double B_double, double T_double, double sz_double, double vz_double, double TCOA_double, double ZTHR_double, double E_0_double, double E_1_double, double E_2_double, double E_3_double, double E_4_double) {
  struct maybeDouble res_double;
  struct maybeDouble aux_0_double = coalt_entry_fp (sz_double, vz_double, TCOA_double, ZTHR_double, E_0_double, E_1_double);
  struct maybeDouble aux_1_double = max__fp (B_double, centry_double, E_2_double);
  if ((aux_0_double.isValid) && (aux_1_double.isValid))
  { if ((vz_double > E_0_double) || (vz_double < - (E_0_double)))
    { if (aux_0_double.isValid)
      { double centry_double = aux_0_double.value;
        ...
        { if ((T_double - centry_double) < - (E_3_double))
          { res_double = someDouble((B_double - T_double));
          } else { if ((T_double - centry_double) >= E_3_double)
                   { res_double = someDouble(aux_1_double.value);
                   } else { res_double = noneDouble();
                   }
          }
    ...
    else if (((fabs(sz_double) - ZTHR_double) <= - (E_4_double)) && ((vz_double <= - (E_0_double)) && (vz_double >= E_0_double)))
...
ensures (\true
         ==> (\forall real B, real T, real sz, real vz, real TCOA, real ZTHR; ((((((((((1 <= B) && (B <= 10)) && ((1 <= T) && (T <= 10))) && ((1 <= sz) && (sz <= 2))) && ((1 <= vz) && (vz <= 2))) && ((2 <= TCOA) && (TCOA <= 3))) && ((2 <= ZTHR) && (ZTHR <= 3))) && ((\result.isValid && (((((\is_finite(B_double) && \is_finite(T_double)) && \is_finite(sz_double)) && \is_finite(vz_double)) && \is_finite(TCOA_double)) && \is_finite(ZTHR_double))) && (((((\abs(B_double - B) <= ulp_dp(B)/2 && \abs(T_double - T) <= ulp_dp(T)/2) && \abs(sz_double - sz) <= ulp_dp(sz)/2) && \abs(vz_double - vz) <= ulp_dp(vz)/2) && \abs(TCOA_double - TCOA) <= ulp_dp(TCOA)/2) && \abs(ZTHR_double - ZTHR) <= ulp_dp(ZTHR)/2)))
                                                                                ==> ((\abs((\result.value - vertical_WCV_exit_minus_entry(B, T, sz, vz, TCOA, ZTHR))) <= 0x1.4000000000004p-47)))))) ;
*/
struct maybeDouble vertical_WCV_exit_minus_entry_num (double B_double, double T_double, double sz_double, double vz_double, double TCOA_double, double ZTHR_double) {
  return vertical_WCV_exit_minus_entry_fp (B_double, T_double, sz_double, vz_double, TCOA_double, ZTHR_double, 0x1p-52, 0x1.4000000000001p-49, 0x1.a000000000004p-47, 0x1.a000000000004p-47, 0x1.8p-51);
}
