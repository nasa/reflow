...
((! (((a - b) >= 0)) && (! (Dge(Dsub(a_double, b_double),  (double) (0))))) || (((a - b) >= 0) && (Dge(Dsub(a_double, b_double),  (double) (0)))));
}
*/
...
((a_double > (double) (0)) || (b_double > (double) (0)));
}
*/
...
behavior structure:
ensures \forall real a, real b; ((\is_finite(E_0_double) && \is_finite(E_1_double))
                                  ==> ((\abs(a_double - a) <= E_0_double &&
                                        \abs(b_double - b) <= E_1_double)
                                    ==> (\result
                                        ==> (( (a, b) && without_call_conditional_function_fp(a_double, b_double)))))) ;
*/
...
ensures \forall real a, real b; ((\result.isValid && \is_finite(E_0_double) && \is_finite(E_1_double))
                                  ==> ((\abs(max__fp(a_double, b_double) - max_(a, b)) <= E_0_double &&
                                        \abs(Dsub(a_double, b_double) - (a - b)) <= E_1_double
                                    ==> (\result.value
...
struct maybeBool with_call_conditional_function_tauplus_fp (double a_double, double b_double, double E_0_double, double E_1_double) {
  ...
  { res = someBool(aux_0_double.value > E_0_double);
  } else { res = noneBool();
  }
  return res;
}
...
*/
struct maybeBool with_call_conditional_function_tauplus_num (double a_double, double b_double) {
...
ensures \forall real a, real b; ((((((1 <= a) && (a <= 2)) && ((1 <= b) && (b <= 2))) && ((\result.isValid && (\is_finite(a_double) && \is_finite(b_double))) && (\abs(a_double - a) <= ulp_dp(a)/2 && \abs(b_double - b) <= ulp_dp(b)/2)))
                                  ==> ((\result.value
                                        ==> (! (with_call_conditional_function(a, b))))))) ;
*/
struct maybeBool with_call_conditional_function_tauminus_num (double a_double, double b_double) {
